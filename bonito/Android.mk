...
ifeq ($(TARGET_DEVICE),bonito sargo)
...
LOCAL_MODULE := ONS
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/priv-app/ONS/ONS.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := platform
LOCAL_PRIVILEGED_MODULE := true
...
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/framework/android.hidl.manager-V1.0-java.jar
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/framework/com.android.future.usb.accessory.jar
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
...
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/framework/com.android.mediadrm.signer.jar
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
...
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/framework/javax.obex.jar
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
